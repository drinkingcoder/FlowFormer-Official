...
def seed_everything_for_reproducibility(seed=42):
    ...
    # benchmark=True will improve training performance but will loose reproducibility.
...
def cosine_annealing(global_step, tot_iterations, n_cycles, max_lr, suraj_modification=False):
    ...
    if suraj_modification:
        curr_cycle = global_step // iters_per_cycle
        max_lr = max_lr * (0.5 ** curr_cycle)
